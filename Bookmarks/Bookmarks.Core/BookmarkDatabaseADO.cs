...
namespace Bookmarks.Core
{
    public class BookmarkDatabase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Bookmark.DL.BookmarkDatabase"/> BookmarkDatabase. 
        ...
        public BookmarkDatabase(string dbPath)
        {
            ...
            if (!exists)
            {
                ...
                connection.Open();
                var commands = new[] {
                    "CREATE TABLE [Items] (_id INTEGER PRIMARY KEY ASC, Name NTEXT, Url NTEXT, Done INTEGER);"
                };
        ...
        public IEnumerable<Bookmark> GetItems()
        {
            var tl = new List<Bookmark>();
            ...
            lock (locker)
            {
                ...
                {
                    contents.CommandText = "SELECT [_id], [Name], [Url], [Done] from [Items]";
